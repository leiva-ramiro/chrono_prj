...
-- Generation de la clock d'entrée 100 A
CLK_IN_int <= not CLK_IN_int after 5 ns;

-- ****************************************
--         Processus de testbench
-- ****************************************
 process
    begin 
        -- On commence avec une horloge de 10 Hz pendant 2 periodes
        SEL_SPEED_CLK_int <= '0'; -- Mode normal (10 Hz)
        wait for 200 ms;
        -- Puis on teste l'horloge rapide 
        SEL_SPEED_CLK_int <= '1'; -- Mode rapide (600 Hz)
        wait for 200 ms;
        -- Puis on revient au mode normal
        SEL_SPEED_CLK_int <= '0'; -- Retour au mode normal (10 Hz)
        wait for 200 ms;
